...
=======
# library(kableExtra)
>>>>>>> 6ceac0053d9781b37d423d38d4581e7b8ff2ae3a
library(magrittr)
library(readr)
library(geosphere)
```
...
recovered <- read.csv(file="./time_series_covid19_recovered_global.csv", stringsAsFactors = FALSE)
deaths <- read.csv(file="./time_series_covid19_deaths_global.csv", stringsAsFactors = FALSE)
