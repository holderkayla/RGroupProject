...
colnames(confirmed)
unique_regions <- select(recovered, Province.State, Country)
non_regions <- select(confirmed, Province.State)
intersect(unique_regions, non_regions)

#filter(confirmed, province.State)
