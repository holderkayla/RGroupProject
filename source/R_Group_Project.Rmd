...
>>>>>>> 83a33e176451886d7f07001af9051c7bf22a7996
...
for (i in 1:length(places)) {
  ...
  if (is.element(places[i], countries)) {
    ...
    # Unfinished: we need to create a running total here
  } 
  else {
...
print(total_data)
# Once everything is working, we need to make these data frames and convert them to tables
# confirmed_totals <- data.frame(countries, total_confir)
# recovery_totals <- data.frame(countries, total_recov)
# death_totals <- data.frame(countries, total_deaths)
